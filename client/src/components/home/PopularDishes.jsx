            ...
            <div className='overflow-y-scroll h-[680px] scrollbar-hide'>
                {
                    popularDishes.map((dish) => {
                        return (
                            <div key={dish.id} className='flex items-center gap-4 bg-[#1f1f1f] rounded-[15px] px-6 mx-6 py-4 mt-4'>
                                <h1 className='text-[#f5f5f5] font-bold text-xl mr-4'>{dish.id < 10 ? `${dish.id}`: dish.id}</h1>
